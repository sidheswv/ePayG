...
public class AddrHygnWidgetConstants {
	...
	static {
		try {
           ...
           /** if(AddrhygnWidgetConstants.DB_SCHEMA.equalsIgnoreCase("dtqwes")){
            	AddrhygnWidgetConstants.APP_EMAIL_ID="AffiliateOrdersTest@custserv.com";
            }else{
            	AddrhygnWidgetConstants.APP_EMAIL_ID="AffiliateOrders@custserv.com";
            } **/
            
           //Log.setReport("Namespace bindings received as-->AffiliateOrders.DBSCHEMA="+AddrHygnWidgetConstants.DB_SCHEMA+" ePayServiceLocation"+AddrhygnWidgetConstants.SERVICE_LOCATION);

      } catch (NamingException e) {
    	  //Log.setReport("Exception occured while reading the namespace bindings for "+AddrHygnWidgetConstants.PROJECT_NAME+" project-->"+e.getMessage());
          e.printStackTrace();
      }
	...
	public static final String EPAY_PRESENTER_ID="SAMORDER";
	public static final String EPAY_CLIENT_ID="SMITHMAG";
